...
from src.method2 import apply_forward_structural_prior


def parse_args():
    parser = argparse.ArgumentParser(description="Train CIFAR-10 ViT experiments with forward structural priors.")
...
def main():
    ...
    fieldnames = ["epoch", "train_loss", "val_loss", "top1_acc", "lr", "epoch_time_sec"]
    ...
    save_json(
        ...
        {"best_top1_acc": best_acc, "final_layer_metrics": final_metrics},
    )
